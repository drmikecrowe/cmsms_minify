...
if (!isset($gCms)) exit;
	...
	/*---------------------------------------------------------
	  ...
	  ---------------------------------------------------------*/
		...
		$sqlarray = $dict->CreateTableSQL(cms_db_prefix()."module_minify",
				$flds, $taboptarray);
		$dict->ExecuteSQLArray($sqlarray);

		// create a sequence
		$db->CreateSequence(cms_db_prefix()."module_minify_seq");
		*/
		
		// permissions
		$this->CreatePermission('Add Stylesheets','Add Stylesheets');
$this->CreatePermission('Modify Stylesheets','Modify Stylesheets');
$this->CreatePermission('Remove Stylesheets','Remove Stylesheets');
$this->CreatePermission('Add Javascripts','Add Javascripts');
$this->CreatePermission('Modify Javascripts','Modify Javascripts');
$this->CreatePermission('Remove Javascripts','Remove Javascripts');
